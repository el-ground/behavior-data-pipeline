...
const ShippingForm = () => {
  ...
  // const activeBillingCountry = shippingCountries[0]
  ...
  const activeShippingCountry = shippingCountries.find((country) => country.code === shippingCountryCode)
  ...
  return (
    <div className="rounded-lg bg-white border-2 border-gainsboro p-3 md:p-6 my-3 md:my-6">
      <h3 className="text-slategray text-2xl md:text-4xl font-bold mb-6">Shipping</h3>
        ...
        {/* {activeShippingCountry && activeShippingCountry.states && (
          <div className="md:w-1/2 mb-3 md:mb-6 px-3">
            <Select
              ...
              options={activeShippingCountry.states.map(({ code: value, name }) => ({
                value,
                name,
              }))}
              errors={errors}
      ...
      {!allowPayment && (
        <div className="flex items-center justify-between">
          <Checkbox name="separateBilling" disabled={disableInput} register={register}>
