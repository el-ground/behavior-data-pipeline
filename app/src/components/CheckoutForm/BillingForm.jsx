...
function BillingForm() {
  ...
  const activeBillingCountry = shippingCountries.find((country) => country.code === billingCountryCode)
  ...
  return (
    <div className="rounded-lg bg-white border-2 border-gainsboro p-3 md:p-6 my-3 md:my-6">
      <h3 className="text-slategray text-2xl md:text-4xl font-bold mb-6">Billing</h3>
        ...
        {/* {activeBillingCountry && activeBillingCountry.states && (
          <div className="md:w-1/2 mb-3 md:mb-6 px-3">
            <Select
              ...
              options={activeBillingCountry.states.map(({ code: value, name }) => ({
                value,
                name,
              }))}
              errors={errors}
