    ...
    <div className="container max-w-screen-xl mx-auto px-6">
      <div className="flex flex-col md:flex-row items-center md:justify-between border-t-2 border-gainsboro py-6">
        ...
        <ul className="inline-flex">
          <li className="my-1">
            <a
              href="https://github.com/el-ground/behavior-data-pipeline"
              target="_blank"
              rel="noopener noreferrer"
              className="text-lightgray hover:text-primary text-sm"
            >
              <svg className="fill-current w-5 h-5 mr-0 md:mr-3" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
