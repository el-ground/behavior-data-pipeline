...
//   const [activeVariantId, setActiveVariantId] = useState(variantId || firstVariant.id)
...
//           <h1 className="font-bold text-3xl md:text-6xl mb-3 text-primary leading-tight">{product.name}</h1>

//           <div className="mb-6">
//             <p className="font-semibold text-2xl text-slategray">{activeVariant && activeVariant.formattedPrice}</p>
//           </div>

//           {product.description && (
//             <div className="mb-6">
//               <p className="leading-loose text-lightgray">{product.description.markdown}</p>
//             </div>
//           )}
